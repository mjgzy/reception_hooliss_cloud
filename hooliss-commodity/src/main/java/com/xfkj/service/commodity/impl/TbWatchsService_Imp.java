package com.xfkj.service.commodity.impl;
...
import com.xfkj.pojo.commodity.*;
...
@Service
public class TbWatchsService_Imp implements TbWatchsService {
    ...
    @Override
    public Integer queryWatchIdByParameterId(Integer parameter_id) throws XFException{
        if (ObjectUtils.isEmpty(parameter_id)){
            throw new XFException("400", "parameter_id is null!");
        }
        return tbWatchsMapper.findWatchIdByParameterId(parameter_id) ;
    }
    ...
    @Override
    public PageInfo findWatchParameterAll() throws XFException{
        final PageInfo watchParameterAll = watchParameterMapper.findWatchParameterAll();
        return watchParameterAll;
    }
    ...
    @Override
    public List<WatchGrade> queryWatchGradeAll() {
        return watchGradeMapper.getAll();
    }
