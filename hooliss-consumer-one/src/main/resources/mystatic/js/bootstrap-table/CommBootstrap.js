...
(function () {
    var BSTable = function (bstableId, url, columns) {
        ...
        this.data = {};
        this.queryParams = function(){}; 		// 向后台传递的自定义参数
        this.responseHandler = function(result){
        	return result;
        };
        this.search = false;
        this.detailView = false;
        this.childTable = function(index, row, $detail){};
    ...
    BSTable.prototype = {
        ...
        init: function () {
            ...
            this.btInstance =
                $('#' + tableId).bootstrapTable({
                    ...
                    search: this.showSearch,              //是否显示表格搜索，此搜索是客户端搜索，不会进服务端
                    ...
                    onExpandRow: this.childTable,
                    dataField:"data",
                    detailView: this.detailView,                   //是否显示父子表
         ...
         * 设置子表内容
         */
        childTable: function (childTable) {
         ...
         * 设置子表内容
         */
        setShowSearch: function (showSearch) {
